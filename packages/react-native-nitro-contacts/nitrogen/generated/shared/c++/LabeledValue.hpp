...
namespace margelo::nitro::nitrocontacts {
  ...
  /**
   * A struct which can be represented as a JavaScript object (LabeledValue).
   */
  struct LabeledValue final {
  public:
  ...
  public:
    ...
    explicit LabeledValue(std::string id, std::string label, std::string value): id(id), label(label), value(value) {}

  public:
    friend bool operator==(const LabeledValue& lhs, const LabeledValue& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ LabeledValue <> JS LabeledValue (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrocontacts::LabeledValue> final {
    static inline margelo::nitro::nitrocontacts::LabeledValue fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrocontacts::LabeledValue(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrocontacts::LabeledValue& arg) {
